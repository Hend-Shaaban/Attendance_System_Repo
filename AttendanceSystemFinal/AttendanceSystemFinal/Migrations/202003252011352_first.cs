namespace AttendanceSystemFinal.Migrations
{
    ...
    public partial class first : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        attTime = c.Time(nullable: false, precision: 7),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Attendances", "stdId", "dbo.Students");
            DropForeignKey("dbo.permissions", "stdId", "dbo.Students");
            ...
            DropIndex("dbo.permissions", new[] { "stdId" });
            DropIndex("dbo.Students", new[] { "DeptNo" });
            DropIndex("dbo.Attendances", new[] { "stdId" });
